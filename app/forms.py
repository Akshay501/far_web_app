...
class ChangePasswordForm(FlaskForm):
    """Any logged-in user (professor or admin) changing their own
    password. The current password must be supplied, so possession of
    an unattended session is not enough to lock the owner out."""
